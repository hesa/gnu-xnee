...
# hesa rules
build-for-cov-prof:
	make CFLAGS="$(COVERAGE_CCOPTS) $(PROFILE_CCOPTS)" CXXFLAGS="$(COVERAGE_CCOPTS) $(PROFILE_CCOPTS)" 
...
cov-prof: init-coverage init-profile build-coverage build-profile gen-coverage gen-profile
